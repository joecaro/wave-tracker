...
const SwellGraph = (props) => {

  useEffect(() => {
    if(new Date().getHours() >= 7){
      document.getElementById('swellRect').setAttribute('fill', props.colors.nightGraphColor)
    }
  ...
  return (
    <div className='GraphCard'>
      <h3>Swell Height {direction}</h3>
      <svg width={width} height={height} className='Graph'>
        <rect id='swellRect' width={width} height={height} fill='#ffffff' rx={15} ry={15} />
